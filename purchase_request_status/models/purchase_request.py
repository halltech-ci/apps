...
class PurchaseRequestLine(models.Model):
    ...
    stock_state = fields.Selection(compute="_compute_stock_state", string="Purchase Status", selection=lambda self: self.env["stock.move"]._fields["state"].selection, store=True,)
